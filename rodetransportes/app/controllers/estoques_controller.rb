class EstoquesController < ApplicationController
  ...
  private
    ...
    def estoque_params
      params.require(:estoque).permit(:veiculo, :placa, :cor, :ano, :chassi, :chave, :funciona, :banco, :dataentrada, :reboque, :enderecocoleta, :tipoentrada, :datasaida, :local, :situacao, :transportado)
    end
end
