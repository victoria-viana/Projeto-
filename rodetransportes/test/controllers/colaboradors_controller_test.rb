...
class ColaboradorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create colaborador" do
    assert_difference('Colaborador.count') do
      post colaboradors_url, params: { colaborador: { celular: @colaborador.celular, cpf: @colaborador.cpf, email: @colaborador.email, nome: @colaborador.nome, rg: @colaborador.rg, whatsapp: @colaborador.whatsapp } }
    end
  ...
  test "should update colaborador" do
    patch colaborador_url(@colaborador), params: { colaborador: { celular: @colaborador.celular, cpf: @colaborador.cpf, email: @colaborador.email, nome: @colaborador.nome, rg: @colaborador.rg, whatsapp: @colaborador.whatsapp } }
