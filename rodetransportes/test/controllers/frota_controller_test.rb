...
class FrotaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create frotum" do
    assert_difference('Frotum.count') do
      post frota_url, params: { frotum: { modelo: @frotum.modelo, placa: @frotum.placa, renavan: @frotum.renavan, tipo: @frotum.tipo } }
    end
  ...
  test "should update frotum" do
    patch frotum_url(@frotum), params: { frotum: { modelo: @frotum.modelo, placa: @frotum.placa, renavan: @frotum.renavan, tipo: @frotum.tipo } }
